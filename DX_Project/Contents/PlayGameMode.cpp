...
void APlayGameMode::BeginPlay()
{
	...
	}
	{
		...
		Back0->SetActorLocation({ 0.0f, 10.0f, 200.0f });
	}
	{
		std::shared_ptr<ABack1> Back1 = GetWorld()->SpawnActor<ABack1>("Back0", EObjectOrder::Back);
		Back1->SetActorLocation({ 0.0f, 160.0f, 500.0f });
	}
	{
		std::shared_ptr<ABack2> Back2 = GetWorld()->SpawnActor<ABack2>("Back0", EObjectOrder::Back);
		Back2->SetActorLocation({ 0.0f, 130.0f, 700.0f });
	}
	{
		std::shared_ptr<ABack3> Back3 = GetWorld()->SpawnActor<ABack3>("Back0", EObjectOrder::Back);
		Back3->SetActorLocation({ 0.0f, 150.0f, 900.0f });
	}
	{
